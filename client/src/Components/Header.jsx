...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className="text-4xl max-w-[320px] sm:text-7xl sm:max-w-[590px]
      ...
      <motion.button onClick={onClickHandler} className="sm:text-lg text-white bg-black w-auto mt-8 px-12
      ...
      <motion.div
        ...
        {Array(6).fill('').map((item, index) => (
          ...
          className="rounded hover:scale-105 transition-all duration-300
            ...
            src={index % 2 === 0 ? assets.sample_img_2 : assets.image_1}
      ...
      className="mt-2 text-neutral-600">Generated images from PicPhrase</motion.p>
    </motion.div>
  )
}
